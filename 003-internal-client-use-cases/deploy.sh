...
apigeecli apis create bundle -z ./003-internal-client-use-cases.zip -n 003-internal-client-use-cases -o ${APIGEE_ORG} -t $TOKEN
apigeecli apis deploy -n 003-internal-client-use-cases -o ${APIGEE_ORG} -t $TOKEN -e ${APIGEE_ENV} --rev 1
